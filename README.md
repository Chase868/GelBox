# 🚨 DISCLAIMER 🚨
This is a fork of [Gelatinarm](https://github.com/gitman-101111/gelatinarm), a Jellyfin client for Xbox originally created by gitman-101111.
...
- Increment the **Version** number (e.g., 1.0.7.0 -> 1.0.8.0)
- Save the file
